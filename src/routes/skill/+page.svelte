<div id='skill' class='w-full pt-16'>
    <div class='max-w-screen-xl mx-auto px-8 py-16 text-center md:text-left'>
    <h2 class='text-5xl text-center md:text-3xl uppercase tracking-wider font-bold text-sky-600'>experience</h2>
               <p class='py-4 text-center '>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed 
